...
public class MenuTabbedUI_6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuTabbedUI_6 frame = new MenuTabbedUI_6();
	...
	public MenuTabbedUI_6() throws SQLException, IOException {
		getUserInformation();
		try {
			SMLUtility.getCurrentMonitorInfo(MenuTabbedUI_6.this);
...
//		}
		...
		lblMenu.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource("/images/Main Main Menu small.png")));
		...
		iconLabel.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource("/images/menu.png")));
...
//		menupanel.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		btnRefresh.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource("/images/refresh.png")));
		...
		btnClose.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource("/images/close.png")));
...
//		System.out.println("SQL is : " + sql);
		...
		while (rs.next()) {
			...
			try {
				button.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource(icon)));
			} catch (Exception e) {
...
//			buttonPanel.setBorder(new BevelBorder(BevelBorder.LOWERED));
			...
			JLabel iconLabel = new JLabel();
			try {
				iconLabel.setIcon(new ImageIcon(MenuTabbedUI_6.class.getResource(icon)));
			} catch (Exception e) {
