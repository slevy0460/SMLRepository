...
public class MenuTabbedUI_7 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuTabbedUI_7 frame = new MenuTabbedUI_7();
	...
	public MenuTabbedUI_7() throws SQLException, IOException {
		getUserInformation();
		try {
			SMLUtility.getCurrentMonitorInfo(MenuTabbedUI_7.this);
...
//		}
		...
		lblMenu.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource("/images/Main Main Menu small.png")));
		...
		iconLabel.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource("/images/menu.png")));
...
//		menupanel.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		btnRefresh.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource("/images/refresh.png")));
		...
		btnClose.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource("/images/close.png")));
	...
	private void doPopulateTable(boolean isRefresh) throws SQLException, IOException {
		...
		while (rs.next()) {
			...
			try {
				button.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource(icon)));
			} catch (Exception e) {
...
//			buttonPanel.setBorder(new BevelBorder(BevelBorder.LOWERED));
			...
			JLabel iconLabel = new JLabel();
			try {
				iconLabel.setIcon(new ImageIcon(MenuTabbedUI_7.class.getResource(icon)));
			} catch (Exception e) {
			...
			// Add the horizontal box to the menupanel instead of the button
