...
public class RLMProjectEditForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RLMProjectEditForm frame = new RLMProjectEditForm(null, null);
	 ...
	 */
	public RLMProjectEditForm(String project, String modein) throws UnknownHostException, SQLException {
		int screen = SMLUtility.getCurrentMonitorInfo(RLMProjectEditForm.this);
		this.mode = modein;
		...
		jPanelTop.setBounds(0, 0, 1302, 61);
		...
		jPanelButtons.setBounds(-648, 624, 1950, 48);
		contentPane.add(jPanelButtons);

		JButton btnInquiry = new JButton("Inquiry");
		btnInquiry.setFont(new Font("Dialog", Font.BOLD, 12));
		btnInquiry.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/task-planning.png")));
		...
		btnUpdate.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/updated.png")));
		...
		btnPrint.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/printer.png")));
		jPanelButtons.add(btnPrint);

		JButton btnTicket = new JButton("Ticket");
		btnTicket.setFont(new Font("Dialog", Font.BOLD, 12));
		btnTicket.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/website.png")));
		jPanelButtons.add(btnTicket);

		JButton btnOnedrive = new JButton("OneDrive");
		btnOnedrive.setFont(new Font("Dialog", Font.BOLD, 12));
		btnOnedrive.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/folder.png")));
		...
		btnClose.setIcon(new ImageIcon(RLMProjectEditForm.class.getResource("/images/close.png")));
		...
		jPanelBottom.setBounds(-648, 671, 1950, 33);
		...
		lblDateToProduction.setBounds(585, 130, 150, 14);
		...
		jDateChooserProduction.setBounds(723, 130, 90, 20);
		...
		lblTicket.setBounds(24, 28, 46, 26);
		...
		txtTicketNo.setFont(new Font("Tahoma", Font.BOLD, 10));
		txtTicketNo.setBounds(90, 31, 86, 20);
		JPanelCenter2.add(txtTicketNo);
		txtTicketNo.setColumns(10);
		setTitle("RLM Project Edit/Maintenance");
		doCenterForm();
		Date today = new Date();
...
//		doUpdate();
	...
	private void doInquiry() throws SQLException, ParseException, UnknownHostException {
	...
	private void doPopulate(String project) {
		...
		sql = "SELECT * FROM QUSRSYS.PSRC799J ";
		sql += "LEFT JOIN QUSRSYS.PSRC999J ON PRJ999 = PRJ799 ";
		sql += "WHERE 1 = 1 ";
...
//		System.out.println("SQL is : " + sql);
	...
	private void doInsert799(String project, String mode) {
		...
		sql = "INSERT INTO QUSRSYS.PSRC799J ";
		...
		try {
			rs = SMLUtility.getResultSet(sql, "SYSP03", "UPD");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}

	private void doInsert999(String project, String mode) {
		ResultSet rs = null;
		String type = null;
		String sql = null;
		mode = "UPDATE";
		...
		sql = "INSERT INTO QUSRSYS.PSRC999J ";
...
//		sql += "'" + txtTicketNo.getText().trim() + "', ";
		...
		try {
			rs = SMLUtility.getResultSet(sql, "SYSP03", "INS");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
	...
	private void doUpdate799(String project, String mode) {
		ResultSet rs = null;
		String language = null;
		String startdate = null;
		String testdate = null;
		...
		sql = "UPDATE QUSRSYS.PSRC799J SET ";
	...
	private void doUpdate999(String project, String mode) {
		ResultSet rs = null;
		String type = null;
		String sql = null;

		sql = "UPDATE QUSRSYS.PSRC999J SET ";
