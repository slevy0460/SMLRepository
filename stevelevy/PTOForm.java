...
public class PTOForm extends JFrame {
	 ...
	 */
	public PTOForm() throws SQLException, ParseException, UnknownHostException {
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowActivated(WindowEvent e) {
			}
		});
		int screen = SMLUtility.getCurrentMonitorInfo(PTOForm.this);
		...
		panelSearchPTOdays.setBounds(0, 0, 1464, 215);
		...
		btnSearch.setIcon(new ImageIcon(PTOForm.class.getResource("/images/search.png")));
		btnSearch.setBounds(10, 170, 142, 20);
		...
		btnSave.setIcon(new ImageIcon(PTOForm.class.getResource("/images/updated.png")));
		btnSave.setFont(new Font("Dialog", Font.BOLD, 12));
		panelButtons.add(btnSave);
		btnDelete.setIcon(new ImageIcon(PTOForm.class.getResource("/images/bin.png")));
		...
		btnPrint.setIcon(new ImageIcon(PTOForm.class.getResource("/images/printer.png")));
		...
		btnExcel.setIcon(new ImageIcon(PTOForm.class.getResource("/images/excel.png")));
		...
		btnImport.setIcon(new ImageIcon(PTOForm.class.getResource("/images/download.png")));
		panelButtons.add(btnImport);
		btnClose.setIcon(new ImageIcon(PTOForm.class.getResource("/images/close.png")));
		...
		panelFormName.add(lblClassName);
		...
		panel.setBounds(395, 11, 488, 193);
		panelSearchPTOdays.add(panel);
		panel.setLayout(null);

		txtHolidayBalance = new JTextField();
		txtHolidayBalance.setBounds(147, 118, 86, 20);
		...
		txtNumberofHoliday.setBounds(147, 82, 86, 20);
		...
		txtTotalHoliday.setBounds(147, 46, 86, 20);
		...
		txtPTOBalance.setBounds(372, 118, 86, 20);
		...
		txtNumberofVacation.setBounds(372, 82, 86, 20);
		...
		txtTotalPTO.setBounds(372, 46, 86, 20);
		...
		txtNumberofVacationtScheduled.setBounds(372, 154, 85, 20);
		...
		lblNewLabel_1_1_2.setBounds(25, 156, 99, 14);
		...
		txtNumberofHolidayScheduled.setBounds(147, 154, 85, 20);
		...
		lblNewLabel_2.setBounds(10, 77, 115, 14);
		...
		jdatechosserTo.setBounds(183, 97, 149, 20);
		...
		btnAdd.setIcon(new ImageIcon(PTOForm.class.getResource("/images/plus.png")));
